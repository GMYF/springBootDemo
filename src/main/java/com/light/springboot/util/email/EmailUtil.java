...
public final class EmailUtil  implements Serializable {
    ...
    private EmailUtil(String sender,String passWord,List<String> receiver,List<String> copyReceiver,String content,String subject){
    ...
    public static EmailUtil getInstance(String sender,String passWord,List<String> receiver,List<String> copyReceiver ,String content,String subject){
       return new EmailUtil(sender, passWord, receiver,copyReceiver, content,subject);
    }
